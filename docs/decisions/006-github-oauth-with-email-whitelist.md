...
3. Access control was hardcoded, making it difficult to restrict the application to only a single authorized user (`andi.irhamm@gmail.com`) securely without redeploying code.
